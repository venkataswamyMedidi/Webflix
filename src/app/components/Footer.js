      ...
      <div className="background" style={{ border: "none" }}>
        <footer>
          ...
          <div className="container-fluid ">
            <div className="row">
              <strong className="col-xs-4">
                {" "}
                <b style={{ color: "red", fontSize: "15px" }}>
                  Copyright © 2017, WEBFLIX. All rights reserved.
                </b>
              </strong>
          ...
          <div className="scroll">
            <ScrollToTop showUnder={200}>
              <td>
                <i
                  className="fa fa-2x fa-arrow-circle-up"
                  aria-hidden="true"
                ></i>
              </td>
            </ScrollToTop>
