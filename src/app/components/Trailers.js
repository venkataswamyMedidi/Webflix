          ...
          <div className="list-unstyled video-list-thumbs row">
            <div className="col-xs-4 col-sm-3 col-xs-6">
              <a href="#" title="The Mummy">
                ...
                <em>
                  The Mummy:Action-Adventure film directed by Alex Kurtzman
                </em>
                <span
            ...
            <div className="col-xs-4 col-sm-3 col-xs-6">
              <a href="#" title="Spider-Man: Homecoming">
                ...
                <em>
                  Spider-Man: Homecoming,based on the Marvel Comics by Jon watts
                </em>
            ...
            <div className="col-xs-4 col-sm-3 col-xs-6">
              <a href="#" title="John Wick">
                <div className="embed-responsive embed-responsive-16by9 video-desc">
                  <Player ref="player" poster={wick} src={John}></Player>
                </div>
                <em>
                  John Wick:neo-noir action thriller film directed by Chad
                  Stahelski
                </em>
                <span className="glyphicon glyphicon-play-circle"></span>
              </a>
            ...
            <div className="col-xs-4 col-sm-3 col-xs-6">
              <a href="#" title="Ash vs Evil">
                <div className="embed-responsive embed-responsive-16by9 video-desc">
                  <Player ref="player" poster={evil} src={Ash}></Player>
                </div>
                <em>
                  Ash vs Evil:comedy horror television series developed by Sam
                  Raimi,Ivan Raimi
                </em>
                <span className="glyphicon glyphicon-play-circle"></span>
              </a>
            ...
            <div className="col-xs-4 col-sm-3 col-xs-6">
              <a href="#" title="Iron Fist">
                ...
                <em>
                  Marvel's Iron Fist:web television series created for Netflix
                  by Scott Buck, based on the Marvel Comics{" "}
                </em>
                <span className="glyphicon glyphicon-play-circle"></span>
              </a>
            </div>
            <div className="col-xs-4 col-sm-3 col-xs-6">
              <a href="#" title="War of the planet of the Apes">
                ...
                <em>
                  War for the Planet of the Apes:fiction film directed by Matt
                  Reeves and written by Mark Bomback and Reeves{" "}
                </em>
                <span className="glyphicon glyphicon-play-circle"></span>
              </a>
            </div>
            <div className="col-xs-4 col-sm-3 col-xs-6">
              <a href="#" title="Dunkirk">
                ...
                <em>
                  Dunkirk :English-language war film[nb 2] written, co-produced
